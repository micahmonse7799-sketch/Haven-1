...
export const Leaves: React.FC<LeavesProps> = ({ onBack, currentRoom, onOpenRoomModal }) => {
  const days = ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'];
  const dates = [
    { d: 28, curr: false }, { d: 29, curr: false }, { d: 30, curr: false }, { d: 31, curr: false }, { d: 1, curr: true }, { d: 2, curr: true }, { d: 3, curr: true, isHighlighted: true },
    ...
    <div className="flex flex-col gap-3 animate-in fade-in slide-in-from-bottom-2 duration-300 pb-20">
      ...
      <div className="bg-[#f8f9fa] border border-gray-200 rounded-sm px-4 py-1 flex items-center justify-between text-[11px]">
        <div className="flex items-center gap-1.5 text-gray-500">
          ...
          <span className="opacity-50">/</span>
          <span className="text-blue-500 cursor-pointer">Leaves</span>
        </div>
      ...
      <div className="bg-white border border-gray-200 shadow-sm rounded-sm overflow-hidden flex flex-col h-full min-h-[600px]">
        <div className="px-4 py-2 border-b bg-white flex items-center justify-between">
          <h2 className="text-[17px] font-normal text-gray-700">Leave Management</h2>
          <div className="flex gap-1">
            <button className="bg-white border border-gray-300 text-gray-700 px-3 py-1 rounded-sm text-[12px] hover:bg-gray-50">List View</button>
